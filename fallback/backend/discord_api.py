...
def create_discord_router(
    *,
    ...
    async def complete_link(inp: LinkCompleteInput):
        ...
        if not code_doc:
            raise api_error(400, "YM-LINK-CODE-INVALID", "Le code de liaison est invalide ou expiré.", "Génère un nouveau code dans Paramètres > Discord et utilise-le dans les 10 minutes.")
