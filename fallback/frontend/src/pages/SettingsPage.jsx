...
export default function SettingsPage() {
    ...
    const createDiscordCode = async () => {
        ...
        try {
            ...
            toast.success("Code Discord généré");
                            ...
                            {user.discord_linked ? (
                                ...
                                <>
                                    <ol className="text-sm text-neutral-300 space-y-2 mb-5 list-decimal list-inside">
                                        <li>Générez un code temporaire ci-dessous.</li>
                                    ...
                                    {discordCode ? (
                                        <div className="p-5 rounded-lg border border-[#E8D2A6]/30 bg-[#E8D2A6]/5">
                                            ...
                                            <div className="text-xs text-neutral-500 mt-3">
                                                Expire à {discordCodeExpiresAt ? new Date(discordCodeExpiresAt).toLocaleTimeString("fr-FR", { hour: "2-digit", minute: "2-digit" }) : "—"}.
                                        ...
                                        >
                                            <Link2 size={14} className="mr-2" /> Générer mon code
                                        </Button>
                                    )}
                                </>
                            )}
